...
public class GameManager : MonoBehaviour
{
    ...
    {
        LogicManager.Instance.shuffledDeck1 = LogicManager.Shuffle(LogicManager.Instance.theDeck1);
        LogicManager.Instance.shuffledDeck2 = LogicManager.Shuffle(LogicManager.Instance.theDeck2);
